...
Ext.reg('extensible.eventstore', Calendar102.akgun.cal.EventStore);
/**
...
Ext.reg('extensible.calendarcombo', Calendar102.akgun.cal.CalendarCombo);
/* @private
 * Currently not used
 */
...
Ext.reg('extensible.recurrencecombo', Calendar102.akgun.cal.RecurrenceCombo);
/* @private
 * Currently not used
...
Ext.reg('extensible.recurrencefield', Calendar102.akgun.cal.RecurrenceField);
/**
...
Ext.reg('extensible.daterangefield', Calendar102.akgun.cal.DateRangeField);
/**
...
Ext.reg('extensible.reminderfield', Calendar102.akgun.cal.ReminderField);
/**
...
Ext.reg('extensible.calendarcolorpalette', Calendar102.akgun.cal.ColorPalette);/**
...
Ext.reg('extensible.calendarlistmenu', Calendar102.akgun.cal.CalendarListMenu);/**
...
Ext.reg('extensible.eventcontextmenu', Calendar102.akgun.cal.EventContextMenu);/**
...
Ext.reg('extensible.calendarlist', Calendar102.akgun.cal.CalendarList);/**
...
Ext.reg('extensible.eventeditform', Calendar102.akgun.cal.EventEditForm);
/**
...
Ext.reg('extensible.eventeditwindow', Calendar102.akgun.cal.EventEditWindow);/**
...
Ext.reg('extensible.monthview', Calendar102.akgun.cal.MonthView);
/**
...
Ext.reg('extensible.dayheaderview', Calendar102.akgun.cal.DayHeaderView);
/**
...
Ext.reg('extensible.daybodyview', Calendar102.akgun.cal.DayBodyView);
/**
...
Ext.reg('extensible.dayview', Calendar102.akgun.cal.DayView);
/**
...
Ext.reg('extensible.multidayview', Calendar102.akgun.cal.MultiDayView);/**
...
Ext.reg('extensible.weekview', Calendar102.akgun.cal.WeekView);/**
...
Ext.reg('extensible.multiweekview', Calendar102.akgun.cal.MultiWeekView);/*
...
Ext.reg('extensible.monthdaydetailview', Calendar102.akgun.cal.MonthDayDetailView);
/**
...
Calendar102.akgun.cal.CalendarPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent : function(){
        ...
        if(this.showNavJump){
            this.tbar.items.push([
                this.jumpToText,
                {id: this.id+'-tb-jump-dt', xtype: 'datefield', showToday: false, format: 'd/m/Y'},
...
Ext.reg('extensible.calendarpanel', Calendar102.akgun.cal.CalendarPanel);