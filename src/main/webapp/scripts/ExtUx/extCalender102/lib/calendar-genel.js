...
(function(){
    ...
    Ext.ns('Calendar102.akgun.ux', 'Calendar102.akgun.sample', 'Calendar102.akgun.plugins', 'Calendar102.akgun.cal');
    ...
    Ext.apply(Calendar102.akgun, {
       ...
       /**
        * @class Calendar102.akgun.cal.Date
        * @extends Object
        ...
        */
	    Date : {
             ...
             * of calendar days (ignoring time) between two dates use {@link Calendar102.akgun.Date.diffDays diffDays} instead.
             ...
             * exact time difference, use {@link Calendar102.akgun.Date.diff diff} instead.
             * @param {Date} start The start date
             * @param {Date} end The end date
 ...
 * @class Calendar102.akgun.cal.DayHeaderTemplate
 * @extends Ext.XTemplate
 * <p>This is the template used to render the all-day event container used in {@link Calendar102.akgun.cal.DayView DayView} and 
 * {@link Calendar102.akgun.cal.WeekView WeekView}. Internally the majority of the layout logic is deferred to an instance of
 * {@link Calendar102.akgun.cal.BoxLayoutTemplate}.</p> 
 * <p>This template is automatically bound to the underlying event store by the 
 * calendar components and expects records of type {@link Calendar102.akgun.cal.EventRecord}.</p>
 * <p>Note that this template would not normally be used directly. Instead you would use the {@link Calendar102.akgun.cal.DayViewTemplate}
 * that internally creates an instance of this template along with a {@link Calendar102.akgun.cal.DayBodyTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.DayHeaderTemplate = function(config){
    
    Ext.apply(this, config);
    
    this.allDayTpl = new Calendar102.akgun.cal.BoxLayoutTemplate(config);
    this.allDayTpl.compile();
    
    Calendar102.akgun.cal.DayHeaderTemplate.superclass.constructor.call(this,
...
Ext.extend(Calendar102.akgun.cal.DayHeaderTemplate, Ext.XTemplate, {
    // private
    applyTemplate : function(o){
        return Calendar102.akgun.cal.DayHeaderTemplate.superclass.applyTemplate.call(this, {
            allDayTpl: this.allDayTpl.apply(o)
        });
    }
});

Calendar102.akgun.cal.DayHeaderTemplate.prototype.apply = Calendar102.akgun.cal.DayHeaderTemplate.prototype.applyTemplate;
/**
 * @class Calendar102.akgun.cal.DayBodyTemplate
 * @extends Ext.XTemplate
 * <p>This is the template used to render the scrolling body container used in {@link Calendar102.akgun.cal.DayView DayView} and 
 * {@link Calendar102.akgun.cal.WeekView WeekView}. This template is automatically bound to the underlying event store by the 
 * calendar components and expects records of type {@link Calendar102.akgun.cal.EventRecord}.</p>
 * <p>Note that this template would not normally be used directly. Instead you would use the {@link Calendar102.akgun.cal.DayViewTemplate}
 * that internally creates an instance of this template along with a {@link Calendar102.akgun.cal.DayHeaderTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.DayBodyTemplate = function(config){
    
    Ext.apply(this, config);
    
    Calendar102.akgun.cal.DayBodyTemplate.superclass.constructor.call(this,
...
Ext.extend(Calendar102.akgun.cal.DayBodyTemplate, Ext.XTemplate, {
    // private
    applyTemplate : function(o){
        ...
        var times = [],
            ...
            fmt = Calendar102.akgun.Date.use24HourTime ? 'G:i' : 'ga';
        ...
        return Calendar102.akgun.cal.DayBodyTemplate.superclass.applyTemplate.call(this, {
            days: days,
...
Calendar102.akgun.cal.DayBodyTemplate.prototype.apply = Calendar102.akgun.cal.DayBodyTemplate.prototype.applyTemplate;
/**
 * @class Calendar102.akgun.cal.BoxLayoutTemplate
 * @extends Ext.XTemplate
 * <p>This is the template used to render calendar views based on small day boxes within a non-scrolling container (currently
 * the {@link Calendar102.akgun.cal.MonthView MonthView} and the all-day headers for {@link Calendar102.akgun.cal.DayView DayView} and 
 * {@link Calendar102.akgun.cal.WeekView WeekView}. This template is automatically bound to the underlying event store by the 
 * calendar components and expects records of type {@link Calendar102.akgun.cal.EventRecord}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.BoxLayoutTemplate = function(config){
    
    Ext.apply(this, config);
    
    var weekLinkTpl = this.showWeekLinks ? '<div id="{weekLinkId}" class="ext-cal-week-link">{weekNum}</div>' : '';
    
    Calendar102.akgun.cal.BoxLayoutTemplate.superclass.constructor.call(this,
        '<tpl for="weeks">',
...
Ext.extend(Calendar102.akgun.cal.BoxLayoutTemplate, Ext.XTemplate, {
    /**
     ...
     * above the first row (e.g., {@link Calendar102.akgun.cal.MonthView#showHeader MonthView.showHeader} = true)
    ...
    applyTemplate : function(o){
        ...
        return Calendar102.akgun.cal.BoxLayoutTemplate.superclass.applyTemplate.call(this, {
            weeks: weeks
        });
    },
    ...
    getTodayText : function(){
        var timeFmt = Calendar102.akgun.Date.use24HourTime ? 'G:i ' : 'g:ia ',
...
Calendar102.akgun.cal.BoxLayoutTemplate.prototype.apply = Calendar102.akgun.cal.BoxLayoutTemplate.prototype.applyTemplate;
/**
 * @class Calendar102.akgun.cal.MonthViewTemplate
 * @extends Ext.XTemplate
 * <p>This is the template used to render the {@link Calendar102.akgun.cal.MonthView MonthView}. Internally this class defers to an
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.MonthViewTemplate = function(config){
    
    Ext.apply(this, config);
    
    this.weekTpl = new Calendar102.akgun.cal.BoxLayoutTemplate(config);
    this.weekTpl.compile();
    
    var weekLinkTpl = this.showWeekLinks ? '<div class="ext-cal-week-link-hd">&#160;</div>' : '';
    
    Calendar102.akgun.cal.MonthViewTemplate.superclass.constructor.call(this,
...
Ext.extend(Calendar102.akgun.cal.MonthViewTemplate, Ext.XTemplate, {
    /**
    ...
    applyTemplate : function(o){
        ...
        return Calendar102.akgun.cal.MonthViewTemplate.superclass.applyTemplate.call(this, {
            days: days,
            weeks: weeks,
...
Calendar102.akgun.cal.MonthViewTemplate.prototype.apply = Calendar102.akgun.cal.MonthViewTemplate.prototype.applyTemplate;
/* @private
 ...
 * @class Calendar102.akgun.cal.StatusProxy
 ...
 * @param {Object} config
 */
Calendar102.akgun.cal.StatusProxy = function(config){
    Ext.apply(this, config);
...
Ext.extend(Calendar102.akgun.cal.StatusProxy, Ext.dd.StatusProxy, {
    /**
 ...
 */
Calendar102.akgun.cal.DragZone = Ext.extend(Ext.dd.DragZone, {
    ddGroup : 'CalendarDD',
    eventSelector : '.ext-cal-evt',
    
    constructor : function(el, config){
        if(!Calendar102.akgun.cal._statusProxyInstance){
            Calendar102.akgun.cal._statusProxyInstance = new Calendar102.akgun.cal.StatusProxy();
        }
        this.proxy = Calendar102.akgun.cal._statusProxyInstance;
        Calendar102.akgun.cal.DragZone.superclass.constructor.call(this, el, config);
    },
    ...
    getDragData : function(e){
        ...
        if(t){
            ...
            return {
                type: 'eventdrag',
                ddel: t,
                eventStart: rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name],
                eventEnd: rec.data[Calendar102.akgun.cal.EventMappings.EndDate.name],
                proxy: this.proxy
            };
        }
    ...
    destroy : function(){
        Calendar102.akgun.cal.DragZone.superclass.destroy.call(this);
        delete Calendar102.akgun.cal._statusProxyInstance;
    }    
});
 ...
 * and is primarily for the month view -- DayViewDD adds day/week view-specific functionality.
 */
Calendar102.akgun.cal.DropZone = Ext.extend(Ext.dd.DropZone, {
    ddGroup : 'CalendarDD',
    eventSelector : '.ext-cal-evt',
    dateRangeFormat : '{0}-{1}',
    dateFormat : 'n/j',
    ...
    shim : function(start, end){
        ...
        var dt = start.clone(),
            i = 0, shim, box,
            cnt = Calendar102.akgun.Date.diffDays(dt, end)+1
        ...
        if(n && data){
            if(data.type == 'eventdrag'){
                var rec = this.view.getEventRecordFromEl(data.ddel),
                    dt = Calendar102.akgun.Date.copyTime(rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name], n.date);
 ...
 */
Calendar102.akgun.cal.DayViewDragZone = Ext.extend(Calendar102.akgun.cal.DragZone, {
    ddGroup : 'DayViewDD',
 ...
 */
Calendar102.akgun.cal.DayViewDropZone = Ext.extend(Calendar102.akgun.cal.DropZone, {
    ddGroup : 'DayViewDD',
    dateRangeFormat : '{0}-{1}',
    dateFormat : 'n/j',
    ...
    onNodeOver : function(n, dd, e, data){
        var dt, text = this.createText,
            timeFormat = Calendar102.akgun.Date.use24HourTime ? 'G:i' : 'g:ia';
        ...
        if(data.type == 'caldrag'){
            ...
            var diff = Calendar102.akgun.Date.diff(this.dragCreateDt, n.date),
                curr = this.dragCreateDt.add(Date.MILLI, diff);
            
            this.dragStartDate = Calendar102.akgun.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || Calendar102.akgun.Date.max(this.dragCreateDt, curr);
            ...
            if(data.type == 'eventresize'){
                ...
                var diff = Calendar102.akgun.Date.diff(this.resizeDt, n.date),
                    curr = this.resizeDt.add(Date.MILLI, diff),
                    start = Calendar102.akgun.Date.min(data.eventStart, curr),
                    end = Calendar102.akgun.Date.max(data.eventStart, curr);
...
Calendar102.akgun.cal.EventStore = Ext.extend(Ext.data.Store, {
    constructor: function(config){
        ...
        Calendar102.akgun.cal.EventStore.superclass.constructor.apply(this, arguments);
    },
    
    load : function(o){
        Calendar102.akgun.log('store load');
        ...
        Calendar102.akgun.cal.EventStore.superclass.load.call(this, o);
    }
...
//            }
//        }
//        Calendar102.akgun.cal.EventStore.superclass.execute.apply(this, arguments);
//    }
});

Ext.reg('extensible102.eventstore', Calendar102.akgun.cal.EventStore);
/**
 * @class Calendar102.akgun.cal.EventMappings
 * @extends Object
 * <p>A simple object that provides the field definitions for 
 * {@link Calendar102.akgun.cal.EventRecord EventRecord}s so that they can be easily overridden.</p>
 * 
 ...
 * <pre><code>
var M = Calendar102.akgun.cal.EventMappings;
M.Title.mapping = 'evt_title';
M.Title.name = 'EventTitle';
Calendar102.akgun.cal.EventRecord.reconfigure();
</code></pre>
 * 
...
Calendar102.akgun.cal.EventMappings.Timestamp = {
    name: 'Timestamp',
    mapping: 'timestamp',
    type: 'date'
};
 ...
 * <pre><code>
Calendar102.akgun.cal.EventMappings = {
...
var reader = new Ext.data.JsonReader({
    ...
    idProperty: Calendar102.akgun.cal.EventMappings.EventId.mapping  || 'id',
    
    // this is also a handy way to configure your reader's fields generically:
    fields: Calendar102.akgun.cal.EventRecord.prototype.fields.getRange()
});
</code></pre>
 */
Calendar102.akgun.cal.EventMappings = {
 ...
 * @class Calendar102.akgun.cal.CalendarMappings
 * @extends Object
 * A simple object that provides the field definitions for 
 * {@link Calendar102.akgun.cal.CalendarRecord CalendarRecord}s so that they can be easily overridden.
 * 
 ...
 * reconfigure it. The simplest approach is to only override specific field attributes:</p>
 * <pre><code>
var M = Calendar102.akgun.cal.CalendarMappings;
M.Title.mapping = 'cal_title';
M.Title.name = 'CalTitle';
Calendar102.akgun.cal.CalendarRecord.reconfigure();
</code></pre>
 * 
 * <p>You can alternately override an entire field definition using object-literal syntax, or 
 * provide your own custom field definitions (as in the following example). Note that if you do 
...
Calendar102.akgun.cal.CalendarMappings.Owner = {
    name: 'Owner',
    mapping: 'owner',
    type: 'string'
};
 ...
 * is the key used to access the field data programmatically.</p>
 * <pre><code>
Calendar102.akgun.cal.CalendarMappings = {
...
var reader = new Ext.data.JsonReader({
    ...
    // read the id property generically, regardless of the mapping:
    idProperty: Calendar102.akgun.cal.CalendarMappings.CalendarId.mapping  || 'id',
    
    // this is also a handy way to configure your reader's fields generically:
    fields: Calendar102.akgun.cal.CalendarRecord.prototype.fields.getRange()
});
</code></pre>
 */
Calendar102.akgun.cal.CalendarMappings = {
 ...
 * @class Calendar102.akgun.cal.EventRecord
 * @extends Ext.data.Record
 * <p>This is the {@link Ext.data.Record Record} specification for calendar event data used by the
 * {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel}'s underlying store. It can be overridden as 
...
rec = new Calendar102.akgun.cal.EventRecord({
 ...
 * If you have overridden any of the record's data mappings via the {@link Calendar102.akgun.cal.EventMappings EventMappings} object
 ...
 */
Calendar102.akgun.cal.EventRecord = Ext.extend(Ext.data.Record, {
...
/**
 * Reconfigures the default record definition based on the current {@link Calendar102.akgun.cal.EventMappings EventMappings}
 * object. See the header documentation for {@link Calendar102.akgun.cal.EventMappings} for complete details and 
 * examples of reconfiguring an EventRecord.
 * @method create
 * @static
 * @return {Function} The updated EventRecord constructor function
 */
Calendar102.akgun.cal.EventRecord.reconfigure = function(){
    var C = Calendar102.akgun.cal,
        M = C.EventMappings,
...
Calendar102.akgun.cal.EventRecord.reconfigure();
/**
 * @class Calendar102.akgun.cal.CalendarRecord
 * @extends Ext.data.Record
 * <p>This is the {@link Ext.data.Record Record} specification for calendar items used by the
 * {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel}'s calendar store. If your model fields 
 ...
 * <p>Here is a basic example for how to create a new record of this type:<pre><code>
rec = new Calendar102.akgun.cal.CalendarRecord({
    CalendarId: 5,
    Title: 'My Holidays',
 ...
 * If you have overridden any of the record's data mappings via the {@link Calendar102.akgun.cal.CalendarMappings CalendarMappings} object
 ...
 * Record will be created with an {@link #Record.id automatically generated id}.
 */
Calendar102.akgun.cal.CalendarRecord = Ext.extend(Ext.data.Record, {
    fields: new Ext.util.MixedCollection(false, function(field){
        return field.name;
    })
});
...
/**
 * Reconfigures the default record definition based on the current {@link Calendar102.akgun.cal.CalendarMappings CalendarMappings}
 * object. See the header documentation for {@link Calendar102.akgun.cal.CalendarMappings} for complete details and 
 * examples of reconfiguring a CalendarRecord.
 * @method create
 * @static
 * @return {Function} The updated CalendarRecord constructor function
 */
Calendar102.akgun.cal.CalendarRecord.reconfigure = function(){
    var C = Calendar102.akgun.cal,
...
// Create the default definition now:
Calendar102.akgun.cal.CalendarRecord.reconfigure();/* @private
 ...
 */
Calendar102.akgun.cal.WeekEventRenderer = function() {
    /**
    ...
    var renderEvent = function(event, weekIndex, dayIndex, eventIndex, dayCount, currentDate, renderConfig) {
        var eventMappings = Calendar102.akgun.cal.EventMappings,
            ...
            daysToEventEnd = Calendar102.akgun.Date.diffDays(currentDate, eventData[eventMappings.EndDate.name]) + 1,
    ...
    return {
         ...
         * extensible102.calendar.view.Month.renderItems() to see what gets passed).
         * @private
         */
 ...
 * @class Calendar102.akgun.cal.CalendarCombo
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.CalendarCombo = Ext.extend(Ext.form.ComboBox, {
    fieldLabel: 'Calendar',
    triggerAction: 'all',
    mode: 'local',
    forceSelection: true,
    ...
    afterRender: function(){
        Calendar102.akgun.cal.CalendarCombo.superclass.afterRender.call(this);
    ...
    getStyleClass: function(calendarId){
        if(calendarId && calendarId !== ''){
            ...
            return 'x-cal-' + rec.data[Calendar102.akgun.cal.CalendarMappings.ColorId.name];
        }
    },
    ...
    setValue: function(value) {
        ...
        value = value || this.store.getAt(0).data[Calendar102.akgun.cal.CalendarMappings.CalendarId.name];
        Calendar102.akgun.cal.CalendarCombo.superclass.setValue.call(this, value);
        this.wrap.addClass(this.getStyleClass(value));
    }
});

Ext.reg('extensible102.calendarcombo', Calendar102.akgun.cal.CalendarCombo);
/* @private
 * Currently not used
 */
Calendar102.akgun.cal.RecurrenceCombo = Ext.extend(Ext.form.ComboBox, {
    width: 160,
    fieldLabel: 'Repeats',
    mode: 'local',
    triggerAction: 'all',
    ...
    initComponent: function(){
        Calendar102.akgun.cal.RecurrenceCombo.superclass.initComponent.call(this);
    ...
    initValue : function(){
        Calendar102.akgun.cal.RecurrenceCombo.superclass.initValue.call(this);
    ...
    setValue : function(v){
        var old = this.value;
        Calendar102.akgun.cal.RecurrenceCombo.superclass.setValue.call(this, v);
        if(old != v){
...
Ext.reg('extensible102.recurrencecombo', Calendar102.akgun.cal.RecurrenceCombo);
/* @private
 * Currently not used
 * Rrule info: http://www.kanzaki.com/docs/ical/rrule.html
 */
Calendar102.akgun.cal.RecurrenceField = Ext.extend(Ext.form.Field, {
    ...
    initComponent : function(){
        Calendar102.akgun.cal.RecurrenceField.superclass.initComponent.call(this);
        if(!this.height){
    ...
    onRender: function(ct, position){
        if(!this.el){
            this.frequencyCombo = new Calendar102.akgun.cal.RecurrenceCombo({
        ...
        Calendar102.akgun.cal.RecurrenceField.superclass.onRender.call(this, ct, position);
    },
    
//    afterRender : function(){
//        Calendar102.akgun.cal.RecurrenceField.superclass.afterRender.call(this);
...
//    },
    ...
    initSubComponents : function(){
        Calendar102.akgun.cal.recurrenceBase = Ext.extend(Ext.Container, {
            fieldLabel: ' ',
            labelSeparator: '',
            hideLabel: true,
            layout: 'table',
        ...
        this.repeatEvery = new Calendar102.akgun.cal.recurrenceBase({
            id: this.id+'-every',
            layoutConfig: {
                columns: 3
            },
            ...
            afterRender: function(){
                Calendar102.akgun.cal.recurrenceBase.superclass.afterRender.call(this);
                this.updateLabel();
            }
        });
            
        this.weekly = new Calendar102.akgun.cal.recurrenceBase({
            id: this.id+'-weekly',
            layoutConfig: {
                columns: 2
            },
        ...
        this.monthly = new Calendar102.akgun.cal.recurrenceBase({
            id: this.id+'-monthly',
            layoutConfig: {
                columns: 3
            },
        ...
        this.yearly = new Calendar102.akgun.cal.recurrenceBase({
            id: this.id+'-yearly',
            layoutConfig: {
                columns: 3
            },
        ...
        this.until = new Calendar102.akgun.cal.recurrenceBase({
            id: this.id+'-until',
...
Ext.reg('extensible102.recurrencefield', Calendar102.akgun.cal.RecurrenceField);
/**
 * @class Calendar102.akgun.cal.DateRangeField
 * @extends Ext.form.Field
 * <p>A combination field that includes start and end dates and times, as well as an optional all-day checkbox.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.DateRangeField = Ext.extend(Ext.form.Field, {
    /**
     * @cfg {String} toText
     ...
     * {@link Calendar102.akgun.Date.use24HourTime} setting and sets the format to 'g:i A' for 12-hour time (e.g., 1:30 PM) 
     * or 'G:i' for 24-hour time (e.g., 13:30). This can also be overridden by a static format string if desired.
     */
    timeFormat: Calendar102.akgun.Date.use24HourTime ? 'G:i' : 'g:i A',
    ...
    onRender: function(ct, position){
        ...
        Calendar102.akgun.cal.DateRangeField.superclass.onRender.call(this, ct, position);
     ...
     * as defined in {@link Calendar102.akgun.cal.EventMappings}.</div></li><ul></div>
     */
    setValue: function(v){
        if(Ext.isArray(v)){
        ...
        else if(v[Calendar102.akgun.cal.EventMappings.StartDate.name]){ //object
            this.setDT(v[Calendar102.akgun.cal.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[Calendar102.akgun.cal.EventMappings.EndDate.name], 'end')){
                this.setDT(v[Calendar102.akgun.cal.EventMappings.StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[Calendar102.akgun.cal.EventMappings.IsAllDay.name]);
        }
    },
    ...
    beforeDestroy: function(){
        ...
        Calendar102.akgun.cal.DateRangeField.superclass.beforeDestroy.call(this);
    },
...
Ext.reg('extensible102.daterangefield', Calendar102.akgun.cal.DateRangeField);
/**
 * @class Calendar102.akgun.cal.ReminderField
 * @extends Ext.form.ComboBox
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.ReminderField = Ext.extend(Ext.form.ComboBox, {
    width: 200,
    fieldLabel: 'Reminder',
    mode: 'local',
    triggerAction: 'all',
    ...
    // private
    initComponent: function(){
        Calendar102.akgun.cal.ReminderField.superclass.initComponent.call(this);
        this.store = this.store || new Ext.data.ArrayStore({
...
Ext.reg('extensible102.reminderfield', Calendar102.akgun.cal.ReminderField);
/**
 * @class Calendar102.akgun.cal.ColorPalette
 ...
 * @param {Object} config The config object
 * @xtype extensible102.calendarcolorpalette
 */
Calendar102.akgun.cal.ColorPalette = Ext.extend(Ext.ColorPalette, {
     ...
     * <li><code>palette</code> : ColorPalette<div class="sub-desc">The {@link #palette Calendar102.akgun.cal.ColorPalette} instance.</div></li>
    ...
    // private
    initComponent: function(){
        Calendar102.akgun.cal.ColorPalette.superclass.initComponent.call(this);
...
Ext.reg('extensible102.calendarcolorpalette', Calendar102.akgun.cal.ColorPalette);/**
 * @class Calendar102.akgun.cal.CalendarListMenu
 * @extends Ext.menu.Menu
 * <p>A menu containing a {@link Calendar102.akgun.cal.ColorPalette palette} for choosing calendar colors, 
 * as well as other calendar-specific options.</p>
 * @xtype extensible102.calendarlistmenu
 */
Calendar102.akgun.cal.CalendarListMenu = Ext.extend(Ext.menu.Menu, {
    /** 
     ...
     * @property palette
     * @type ColorPalette
     * The {@link Calendar102.akgun.cal.ColorPalette ColorPalette} instance for this CalendarListMenu
     */
    ...
    initComponent : function(){
        ...
        Calendar102.akgun.cal.CalendarListMenu.superclass.initComponent.call(this);
    },
    
    // private
    afterRender: function(){
        Calendar102.akgun.cal.CalendarListMenu.superclass.afterRender.call(this);
        this.palette = this.findByType('extensible102.calendarcolorpalette')[0];
     ...
     * @return {Calendar102.akgun.cal.CalendarListMenu} this
     */
...
Ext.reg('extensible102.calendarlistmenu', Calendar102.akgun.cal.CalendarListMenu);/**
 * @class Calendar102.akgun.cal.EventContextMenu
 * @extends Ext.menu.Menu
 * The context menu displayed for calendar events in any {@link Calendar102.akgun.cal.CalendarView CalendarView} subclass. 
 * @xtype extensible102.eventcontextmenu
 */
Calendar102.akgun.cal.EventContextMenu = Ext.extend(Ext.menu.Menu, {
    /** 
     * @cfg {Boolean} hideOnClick
     * False to continue showing the menu after a color is selected, defaults to true.
     */
    ...
    initComponent : function(){
        this.addEvents(
             ...
             * (by default, in an instance of {@link Calendar102.akgun.cal.EventEditForm}. Handling code should 
             * transfer the current event record to the appropriate instance of the detailed form by showing
             * the form and calling {@link Calendar102.akgun.cal.EventEditForm#loadRecord loadRecord}.
             * @param {Calendar102.akgun.cal.EventContextMenu} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} that is currently being edited
             ...
             * @param {Calendar102.akgun.cal.EventContextMenu} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event to be deleted
             * @param {Ext.Element} el The element associated with this context menu
             */
            'eventdelete',
            /**
             ...
             * @param {Calendar102.akgun.cal.EventContextMenu} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event to be moved
    ...
    buildMenu: function(){
        ...
        this.dateMenu = new Ext.menu.DateMenu({
            ...
            handler: function(dp, dt){
                dt = Calendar102.akgun.Date.copyTime(this.rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name], dt);
     ...
     * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event
     * @param {Ext.Element} el The element associated with this context menu
    ...
    showForEvent: function(rec, el, xy){
        this.rec = rec;
        this.ctxEl = el;
        this.dateMenu.picker.setValue(rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name]);
        this.showAt(xy);
    },
    
    // private
    onHide : function(){
        Calendar102.akgun.cal.CalendarListMenu.superclass.onHide.call(this);
        delete this.ctxEl;
    }
});

Ext.reg('extensible102.eventcontextmenu', Calendar102.akgun.cal.EventContextMenu);/**
 * @class Calendar102.akgun.cal.CalendarList
 * @extends Ext.Panel
 ...
 * @xtype calendarpanel
 */
Calendar102.akgun.cal.CalendarList = Ext.extend(Ext.Panel, {
    title: 'Calendars',
    collapsible: true,
    autoHeight: true,
    layout: 'fit',
     ...
     * A {@link Ext.data.Store store} containing records of type {@link Calendar102.akgun.cal.CalendarRecord CalendarRecord}.
    ...
    initComponent: function(){
        ...
        Calendar102.akgun.cal.CalendarList.superclass.initComponent.call(this);
    },
    
    // private
    afterRender : function(ct, position){
        Calendar102.akgun.cal.CalendarList.superclass.afterRender.call(this);
     ...
     * records of type {@link Calendar102.akgun.cal.CalendarRecord CalendarRecord}.
    ...
    refresh: function(){
        ...
        var data = [], i = 0, o = null,
            CM = Calendar102.akgun.cal.CalendarMappings,
    ...
    showCalendar: function(id, commit){
        var rec = this.store.getById(id);
        if(rec.data[Calendar102.akgun.cal.CalendarMappings.IsHidden.name] === true){
    ...
    radioCalendar: function(id){
        var i = 0, recId,
            calendarId = Calendar102.akgun.cal.CalendarMappings.CalendarId.name,
            recs = this.store.getRange(),
            len = recs.length;
    ...
    handleColorChange: function(menu, id, colorId, origColorId){
        var rec = this.store.getById(id);
        rec.data[Calendar102.akgun.cal.CalendarMappings.ColorId.name] = colorId;
        rec.commit();
    },
    ...
    showEventMenu : function(el, xy){
        var id = this.getCalendarId(el.parent('li')),
            ...
            colorId = rec.data[Calendar102.akgun.cal.CalendarMappings.ColorId.name];
            
        if(!this.menu){
            this.menu = new Calendar102.akgun.cal.CalendarListMenu();
...
Ext.reg('extensible102.calendarlist', Calendar102.akgun.cal.CalendarList);/**
 * @class Calendar102.akgun.cal.EventEditForm
 ...
 * calendar components. It is also configured to automatically bind records of type {@link Calendar102.akgun.cal.EventRecord}
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.EventEditForm = Ext.extend(Ext.form.FormPanel, {
    labelWidth: 65,
    labelWidthRightCol: 65,
    colWidthLeft: .6,
    colWidthRight: .4,
    ...
    initComponent: function(){
        ...
        this.addEvents({
             ...
             * @param {Calendar102.akgun.cal.EventEditForm} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The new {@link Calendar102.akgun.cal.EventRecord record} that was added
             */
            eventadd: true,
            /**
             * @event eventupdate
             ...
             * @param {Calendar102.akgun.cal.EventEditForm} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The new {@link Calendar102.akgun.cal.EventRecord record} that was updated
             */
            eventupdate: true,
            /**
             * @event eventdelete
             ...
             * @param {Calendar102.akgun.cal.EventEditForm} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The new {@link Calendar102.akgun.cal.EventRecord record} that was deleted
             */
            eventdelete: true,
            /**
             * @event eventcancel
             ...
             * @param {Calendar102.akgun.cal.EventEditForm} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The new {@link Calendar102.akgun.cal.EventRecord record} that was canceled
             */
            eventcancel: true
        });
        ...
        this.titleField = new Ext.form.TextField({
            ...
            name: Calendar102.akgun.cal.EventMappings.Title.name,
            anchor: '90%'
        });
        this.dateRangeField = new Calendar102.akgun.cal.DateRangeField({
        ...
        this.reminderField = new Calendar102.akgun.cal.ReminderField({
            name: Calendar102.akgun.cal.EventMappings.Reminder.name,
            fieldLabel: this.reminderLabelText
        });
        this.notesField = new Ext.form.TextArea({
            fieldLabel: this.notesLabelText,
            name: Calendar102.akgun.cal.EventMappings.Notes.name,
            grow: true,
            growMax: 150,
            anchor: '100%'
        });
        this.locationField = new Ext.form.TextField({
            ...
            name: Calendar102.akgun.cal.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.TextField({
            fieldLabel: this.webLinkLabelText,
            name: Calendar102.akgun.cal.EventMappings.Url.name,
            anchor: '100%'
        });
        ...
        if(this.enableRecurrence){
            this.recurrenceField = new Calendar102.akgun.cal.RecurrenceField({
                name: Calendar102.akgun.cal.EventMappings.RRule.name,
        ...
        if(this.calendarStore){
            this.calendarField = new Calendar102.akgun.cal.CalendarCombo({
                store: this.calendarStore,
                fieldLabel: this.calendarLabelText,
                name: Calendar102.akgun.cal.EventMappings.CalendarId.name
            });
        ...
        Calendar102.akgun.cal.EventEditForm.superclass.initComponent.call(this);
    },
    ...
    loadRecord: function(rec){
        ...
        if(this.recurrenceField){
            this.recurrenceField.setStartDate(rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name]);
        }
        if(this.calendarStore){
            this.form.setValues({'calendar': rec.data[Calendar102.akgun.cal.EventMappings.CalendarId.name]});
        }
        
        //this.isAdd = !!rec.data[Calendar102.akgun.cal.EventMappings.IsNew.name];
        if(rec.phantom){
            //rec.markDirty();
    ...
    updateRecord: function(){
        var dates = this.dateRangeField.getValue(),
            M = Calendar102.akgun.cal.EventMappings,
...
Ext.reg('extensible102.eventeditform', Calendar102.akgun.cal.EventEditForm);
/**
 * @class Calendar102.akgun.cal.EventEditWindow
 * @extends Ext.Window
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.EventEditWindow = Ext.extend(Ext.Window, {
    titleTextAdd: 'Add Event',
    titleTextEdit: 'Edit Event',
    width: 600,
    border: true,
    ...
    initComponent: function(){
        this.addEvents({
             ...
             * @event eventadd
             * Fires after a new event is added
             * @param {Calendar102.akgun.cal.EventEditWindow} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The new {@link Calendar102.akgun.cal.EventRecord record} that was added
             ...
             * (by default, an instance of {@link Calendar102.akgun.cal.EventEditForm}. Handling code should hide this window
             * and transfer the current event record to the appropriate instance of the detailed form by showing it
             * and calling {@link Calendar102.akgun.cal.EventEditForm#loadRecord loadRecord}.
             * @param {Calendar102.akgun.cal.EventEditWindow} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} that is currently being edited
             * @param {Ext.Element} el The target element
             */
        ...
        Calendar102.akgun.cal.EventEditWindow.superclass.initComponent.call(this);
    },
    ...
    onRender : function(ct, position){
        ...
        Calendar102.akgun.cal.EventEditWindow.superclass.onRender.call(this, ct, position);
    },

    // private
    afterRender: function(){
        Calendar102.akgun.cal.EventEditWindow.superclass.afterRender.call(this);
    ...
    show: function(o, animateTarget){
		...
		Calendar102.akgun.cal.EventEditWindow.superclass.show.call(this, anim, function(){
...
Ext.reg('extensible102.eventeditwindow', Calendar102.akgun.cal.EventEditWindow);/**
 * @class Calendar102.akgun.cal.CalendarView
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.CalendarView = Ext.extend(Ext.BoxComponent, {
    /**
     * @cfg {Ext.data.Store} eventStore
     * The {@link Ext.data.Store store} which is bound to this calendar and contains {@link Calendar102.akgun.cal.EventRecord EventRecords}.
     ...
     * The {@link Ext.data.Store store} which is bound to this calendar and contains {@link Calendar102.akgun.cal.CalendarRecord CalendarRecords}.
     ...
     * {@link Calendar102.akgun.cal.EventRecord}) to populate the calendar views with events. Internally this method
...
viewConfig: {
     ...
     * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} being rendered
    ...
    initComponent : function(){
        ...
        Calendar102.akgun.cal.CalendarView.superclass.initComponent.call(this);
        ...
        this.addEvents({
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this 
             */
            eventsrendered: true,
            /**
             * @event eventclick
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that was clicked on
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that the cursor is over
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that the cursor exited
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that will be moved
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that was moved with
             ...
             * @param {Calendar102.akgun.cal.CalendarView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that was deleted
             * @param {Ext.Element} el The target element
             */
    ...
    // private
    afterRender : function(){
        Calendar102.akgun.cal.CalendarView.superclass.afterRender.call(this);
    ...
    reloadStore : function(o){
        Calendar102.akgun.log('reloadStore');
        o = Ext.isObject(o) ? o : {};
        o.params = o.params || {};
    ...
    refresh : function(reloadData){
        Calendar102.akgun.log('refresh (base), reload = '+reloadData);
        if(reloadData === true){
            this.reloadStore();
        }
        this.prepareData();
    ...
    getWeekCount : function(){
        var days = Calendar102.akgun.Date.diffDays(this.viewStart, this.viewEnd);
            ...
            for(d = 0; d < this.dayCount; d++){
                if(evtsInView.getCount() > 0){
                    var evts = evtsInView.filterBy(function(rec){
                        var startsOnDate = (dt.getTime() == rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name].clearTime(true).getTime());
                        var spansFromPrevView = (w == 0 && d == 0 && (dt > rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name]));
    ...
    prepareEventGrid : function(evts, w, d) {
        ...
        evts.each(function(evt) {
            ...
            if (Calendar102.akgun.Date.diffDays(evt.data[M.StartDate.name], evt.data[M.EndDate.name]) > 0) {
                var daysInView = Calendar102.akgun.Date.diffDays(
                    Calendar102.akgun.Date.max(me.viewStart, evt.data[M.StartDate.name]),
                    Calendar102.akgun.Date.min(me.viewEnd, evt.data[M.EndDate.name])) + 1;
	...
	onCalendarEndDrag : function(start, end, onComplete){
        ...
        dates[Calendar102.akgun.cal.EventMappings.StartDate.name] = start;
        dates[Calendar102.akgun.cal.EventMappings.EndDate.name] = end;
    ...
    onUpdate : function(ds, rec, operation){
        ...
        if(operation == Ext.data.Record.COMMIT){
            Calendar102.akgun.log('onUpdate');
            this.dismissEventEditor();
            
            var rrule = rec.data[Calendar102.akgun.cal.EventMappings.RRule.name];
			...
			if(this.enableFx && this.enableUpdateFx){
				this.doUpdateFx(this.getEventEls(rec.data[Calendar102.akgun.cal.EventMappings.EventId.name]), {
                    scope: this
                });
			}
        }
    ...
    onAdd : function(ds, recs, index){
		...
		if(this.enableFx && this.enableAddFx){
			this.doAddFx(this.getEventEls(rec.data[Calendar102.akgun.cal.EventMappings.EventId.name]), {
                scope: this
            });
		};
    },
    ...
    onRemove : function(ds, rec){
        ...
        Calendar102.akgun.log('onRemove');
        this.dismissEventEditor();
		...
		if(this.enableFx && this.enableRemoveFx){
			this.doRemoveFx(this.getEventEls(rec.data[Calendar102.akgun.cal.EventMappings.EventId.name]), {
	            remove: true,
	            scope: this,
			...
			this.getEventEls(rec.data[Calendar102.akgun.cal.EventMappings.EventId.name]).remove();
...
//	},
    ...
    onDataChanged : function(store){
        Calendar102.akgun.log('onDataChanged');
        this.refresh(false);
    },
    ...
    isEventVisible : function(evt){
        ...
        if(calRec && calRec.data[Calendar102.akgun.cal.CalendarMappings.IsHidden.name] === true){
        ...
        return Calendar102.akgun.Date.rangesOverlap(start, end, evStart, evEnd);
    },
    ...
    isOverlapping : function(evt1, evt2){
        var ev1 = evt1.data ? evt1.data : evt1,
            ...
            startDiff = Calendar102.akgun.Date.diff(ev1[M.StartDate.name], ev2[M.StartDate.name], 'm');
...
//            ev1SpansEv2 = (start1 < start2 && end1 > end2),
            var evtsOverlap = Calendar102.akgun.Date.rangesOverlap(start1, end1, start2, end2),
    ...
    setStartDate : function(start, /*private*/reload){
        Calendar102.akgun.log('setStartDate (base) '+start.format('Y-m-d'));
...
alert('End: '+bounds.end);
	 ...
	 * of {@link #Calendar102.akgun.cal.EventRecord EventRecord} objects
	 */
	sortEventRecordsForDay: function(evts){
		...
		evts.sort('ASC', function(evtA, evtB){
			...
			if (this.spansHavePriority) {
				...
				var diff = Calendar102.akgun.Date.diffDays;
    ...
    movePrev : function(/*private*/reload){
        var days = Calendar102.akgun.Date.diffDays(this.viewStart, this.viewEnd)+1;
    ...
    /**
     * Sets the event store used by the calendar to display {@link Calendar102.akgun.cal.EventRecord events}.
     * @param {Ext.data.Store} store
     */
    setStore : function(store, initial){
    ...
    /**
     * Sets the calendar store used by the calendar (contains records of type {@link Calendar102.akgun.cal.CalendarRecord CalendarRecord}).
     * @param {Ext.data.Store} store
     */
    ...
    getEventRecord : function(id){
        var idx = this.store.find(Calendar102.akgun.cal.EventMappings.EventId.name, id, 
            0,     // start index
    ...
    getEventEditor : function(){
        ...
        if(!this.editWin){
            this.editWin = new Calendar102.akgun.cal.EventEditWindow({
                id: 'ext-cal-editwin',
     ...
     * {@link Calendar102.akgun.cal.EventEditWindow EventEditWindow}).
     * @param {Calendar102.akgun.cal.EventRecord} rec The event record
     ...
     * @return {Calendar102.akgun.cal.CalendarView} this
     */
     ...
     * {@link Calendar102.akgun.cal.EventEditWindow EventEditWindow}, which will be hidden).
    ...
    showEventMenu : function(el, xy){
        if(!this.eventMenu){
            this.eventMenu = new Calendar102.akgun.cal.EventContextMenu({
                listeners: {
     ...
     * @param {Object} rec The event {@link Calendar102.akgun.cal.EventRecord record}
     * @param {Object} dt The new start date
     */
    moveEvent : function(rec, dt){
        if(Calendar102.akgun.Date.compare(rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name], dt) === 0){
            // no changes
            return;
        }
        if(this.fireEvent('beforeeventmove', this, rec, dt) !== false){
            var diff = dt.getTime() - rec.data[Calendar102.akgun.cal.EventMappings.StartDate.name].getTime();
            rec.beginEdit();
            rec.set(Calendar102.akgun.cal.EventMappings.StartDate.name, dt);
            rec.set(Calendar102.akgun.cal.EventMappings.EndDate.name, rec.data[Calendar102.akgun.cal.EventMappings.EndDate.name].add(Date.MILLI, diff));
            rec.endEdit();
            this.save();
    ...
    // private
    destroy: function(){
        Calendar102.akgun.cal.CalendarView.superclass.destroy.call(this);
        if(this.el){
 ...
 * @class Calendar102.akgun.cal.MonthView
 * @extends Calendar102.akgun.cal.CalendarView
 * <p>Displays a calendar view by month. This class does not usually need ot be used directly as you can
 * use a {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel} to manage multiple calendar views at once including
 * the month view.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.MonthView = Ext.extend(Calendar102.akgun.cal.CalendarView, {
    /**
     * @cfg {String} moreText
     ...
     * True to display an extra column before the first day in the calendar that links to the {@link Calendar102.akgun.cal.WeekView view}
    ...
    // private
    initComponent : function(){
        Calendar102.akgun.cal.MonthView.superclass.initComponent.call(this);
        this.addEvents({
            /**
             * @event dayclick
             ...
             * @param {Calendar102.akgun.cal.MonthView} this
	...
	initDD : function(){
        ...
        this.dragZone = new Calendar102.akgun.cal.DragZone(this.el, cfg);
        this.dropZone = new Calendar102.akgun.cal.DropZone(this.el, cfg);
	},
    ...
    onDestroy : function(){
        ...
        Calendar102.akgun.cal.MonthView.superclass.onDestroy.call(this);
    },
    
    // private
    afterRender : function(){
        if(!this.tpl){
            this.tpl = new Calendar102.akgun.cal.MonthViewTemplate({
                id: this.id,
        ...
        Calendar102.akgun.cal.MonthView.superclass.afterRender.call(this);
    },
    ...
    forceSize: function(){
        ...
        Calendar102.akgun.cal.MonthView.superclass.forceSize.call(this);
    },
            ...
            this.clockTask = Ext.TaskMgr.start({
                run: function(){ 
                    ...
                    if(t.getDay() == this.prevClockDay){
                        if(el){
                            el.update(t.format(Calendar102.akgun.Date.use24HourTime ? 'G:i' : 'g:ia'));
                        }
                    }
                    else{
    ...
    getTemplateEventData : function(evt){
		var M = Calendar102.akgun.cal.EventMappings,
            ...
            fmt = Calendar102.akgun.Date.use24HourTime ? 'G:i ' : 'g:ia ';
        
        if(this.calendarStore && evt[M.CalendarId.name]){
            var rec = this.calendarStore.getById(evt[M.CalendarId.name]);
            if(rec){
                colorCls = 'x-cal-' + rec.data[Calendar102.akgun.cal.CalendarMappings.ColorId.name];
            }
        }
    ...
    // private
	refresh : function(reloadData){
        Calendar102.akgun.log('refresh (MonthView)');
		if(this.detailPanel){
			this.detailPanel.hide();
		}
		Calendar102.akgun.cal.MonthView.superclass.refresh.call(this, reloadData);
    ...
    // private
    renderItems : function(){
        Calendar102.akgun.cal.WeekEventRenderer.render({
    ...
    // private
	onInitDrag : function(){
        Calendar102.akgun.cal.MonthView.superclass.onInitDrag.call(this);
	...
	onMoreClick : function(dt){
		if(!this.detailPanel){
	        this.detailPanel = new Ext.Panel({
				...
				items: {
					xtype: 'extensible102.monthdaydetailview',
    ...
    // private
    onHide : function(){
        Calendar102.akgun.cal.MonthView.superclass.onHide.call(this);
        if(this.detailPanel){
            this.detailPanel.hide();
        }
    },
    ...
    onClick : function(e, t){
        ...
        if(Calendar102.akgun.cal.MonthView.superclass.onClick.apply(this, arguments)){
    ...
    handleDayMouseEvent : function(e, t, type){
        ...
        Calendar102.akgun.cal.MonthView.superclass.handleDayMouseEvent.apply(this, arguments);
    },
    
    // private
    destroy: function(){
        Calendar102.akgun.cal.MonthView.superclass.destroy.call(this);
...
Ext.reg('extensible102.monthview', Calendar102.akgun.cal.MonthView);
/**
 * @class Calendar102.akgun.cal.DayHeaderView
 * @extends Calendar102.akgun.cal.MonthView
 * <p>This is the header area container within the day and week views where all-day events are displayed.
 * Normally you should not need to use this class directly -- instead you should use {@link Calendar102.akgun.cal.DayView DayView}
 * which aggregates this class and the {@link Calendar102.akgun.cal.DayBodyView DayBodyView} into the single unified view
 * presented by {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.DayHeaderView = Ext.extend(Calendar102.akgun.cal.MonthView, {
    // private configs
    weekCount: 1,
    dayCount: 1,
    allDayOnly: true,
     ...
     * returning false from a handler will cancel the click without displaying the event editor view. This could be useful 
     * for validating that a user can only create events on certain days.
     * @param {Calendar102.akgun.cal.DayHeaderView} this
     * @param {Date} dt The date/time that was clicked on
     * @param {Boolean} allday True if the day clicked on represents an all-day box, else false. Clicks within the 
    ...
    afterRender : function(){
        if(!this.tpl){
            this.tpl = new Calendar102.akgun.cal.DayHeaderTemplate({
                id: this.id,
                showTodayText: this.showTodayText,
                todayText: this.todayText,
                showTime: this.showTime
        ...
        Calendar102.akgun.cal.DayHeaderView.superclass.afterRender.call(this);
    },
    ...
    // private
    refresh : function(reloadData){
        Calendar102.akgun.log('refresh (DayHeaderView)');
        Calendar102.akgun.cal.DayHeaderView.superclass.refresh.call(this, reloadData);
    ...
    onClick : function(e, t){
        ...
        Calendar102.akgun.cal.DayHeaderView.superclass.onClick.apply(this, arguments);
    }
});

Ext.reg('extensible102.dayheaderview', Calendar102.akgun.cal.DayHeaderView);
/**
 * @class Calendar102.akgun.cal.DayBodyView
 * @extends Calendar102.akgun.cal.CalendarView
 * <p>This is the scrolling container within the day and week views where non-all-day events are displayed.
 * Normally you should not need to use this class directly -- instead you should use {@link Calendar102.akgun.cal.DayView DayView}
 * which aggregates this class and the {@link Calendar102.akgun.cal.DayHeaderView DayHeaderView} into the single unified view
 * presented by {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.DayBodyView = Ext.extend(Calendar102.akgun.cal.CalendarView, {
    //private
    ...
    //private
    initComponent : function(){
        Calendar102.akgun.cal.DayBodyView.superclass.initComponent.call(this);
        ...
        this.addEvents({
             ...
             * @param {Calendar102.akgun.cal.DayBodyView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The original {@link Calendar102.akgun.cal.EventRecord record} for the event that was resized
             ...
             * @param {Calendar102.akgun.cal.DayBodyView} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} for the event that was resized
    ...
    initDD : function(){
        ...
        this.dragZone = new Calendar102.akgun.cal.DayViewDragZone(this.el, Ext.apply({
            containerScroll: true
        }, cfg));
        
        this.dropZone = new Calendar102.akgun.cal.DayViewDropZone(this.el, cfg);
    },
    
    //private
    refresh : function(reloadData){
        Calendar102.akgun.log('refresh (DayBodyView)');
        var top = this.el.getScroll().top;
        
        Calendar102.akgun.cal.DayBodyView.superclass.refresh.call(this, reloadData);
    ...
    afterRender : function(){
        if(!this.tpl){
            this.tpl = new Calendar102.akgun.cal.DayBodyTemplate({
                id: this.id,
                dayCount: this.dayCount,
                showTodayText: this.showTodayText,
                todayText: this.todayText,
        ...
        Calendar102.akgun.cal.DayBodyView.superclass.afterRender.call(this);
    ...
    onEventResize : function(rec, data){
        if(this.fireEvent('beforeeventresize', this, rec, data) !== false){
            var D = Calendar102.akgun.Date,
                start = Calendar102.akgun.cal.EventMappings.StartDate.name,
                end = Calendar102.akgun.cal.EventMappings.EndDate.name;
...
//                '</tpl>'
    ...
    /**
     * <p>Returns the XTemplate that is bound to the calendar's event store (it expects records of type
     * {@link Calendar102.akgun.cal.EventRecord}) to populate the calendar views with <strong>all-day</strong> events. 
    ...
    getTemplateEventBox : function(evt){
        var heightFactor = this.hourHeight / this.hourIncrement,
            start = evt[Calendar102.akgun.cal.EventMappings.StartDate.name],
            end = evt[Calendar102.akgun.cal.EventMappings.EndDate.name],
    ...
    renderItems: function(){
        ...
        for(; day < this.dayCount; day++){
            ...
            for(; ev < ct; ev++){
                ...
                var item = evt.data || evt.event.data,
                    ...
                    span = Calendar102.akgun.Date.diffDays(item[M.StartDate.name], item[M.EndDate.name]) > 0,
        ...
        for(; i<l; i++){
            var evt = evts[i].data, 
                evt2 = null, 
                dt = evt[Calendar102.akgun.cal.EventMappings.StartDate.name].getDate();
    ...
    // private
    onClick : function(e, t){
        if(this.dragPending || Calendar102.akgun.cal.DayBodyView.superclass.onClick.apply(this, arguments)){
            // The superclass handled the click already so exit
            return;
        }
...
Ext.reg('extensible102.daybodyview', Calendar102.akgun.cal.DayBodyView);
/**
 * @class Calendar102.akgun.cal.DayView
 * @extends Ext.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link Calendar102.akgun.cal.CalendarView CalendarView}.
 * Instead it is a {@link Ext.Container Container} subclass that internally creates and manages the layouts of
 * a {@link Calendar102.akgun.cal.DayHeaderView DayHeaderView} and a {@link Calendar102.akgun.cal.DayBodyView DayBodyView}. As such
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.DayView = Ext.extend(Ext.Container, {
    /**
     * @cfg {String} todayText
     * The text to display in the current day's box in the calendar when {@link #showTodayText} is true (defaults to 'Today')
     */
     ...
     * 'Create event for {0}' where {0} is a date range supplied by the view)
     */
    ddCreateEventText: Calendar102.akgun.cal.CalendarView.prototype.ddCreateEventText,
    /**
     * @cfg {String} ddMoveEventText
     * The text to display inside the drag proxy while dragging an event to reposition it (defaults to 
     * 'Move event to {0}' where {0} is the updated event start date/time supplied by the view)
     */
    ddMoveEventText: Calendar102.akgun.cal.CalendarView.prototype.ddMoveEventText,
    /**
     * @cfg {Boolean} showTime
     * True to display the current time in today's box in the calendar, false to not display it (defaults to true)
     */
    ...
    initComponent : function(){
        ...
        var header = Ext.applyIf({
            xtype: 'extensible102.dayheaderview',
            id: this.id+'-hd',
            ownerCalendarPanel: this.ownerCalendarPanel
        }, cfg);
        
        var body = Ext.applyIf({
            xtype: 'extensible102.daybodyview',
        ...
        Calendar102.akgun.cal.DayView.superclass.initComponent.call(this);
    },
    
    // private
    afterRender : function(){
        Calendar102.akgun.cal.DayView.superclass.afterRender.call(this);
    ...
    // private
    refresh : function(){
        Calendar102.akgun.log('refresh (DayView)');
        this.header.refresh();
        this.body.refresh();
    },
     ...
     * used as the target for animating the editor window opening and closing. If this method is being overridden to
     * supply a custom editor this parameter can be ignored if it does not apply.
     * @return {Calendar102.akgun.cal.DayView} this
     */
    showEventEditor : function(rec, animateTarget){
        return Calendar102.akgun.cal.CalendarView.prototype.showEventEditor.apply(this, arguments);
    },
    ...
    dismissEventEditor : function(dismissMethod){
        return Calendar102.akgun.cal.CalendarView.prototype.dismissEventEditor.apply(this, arguments);
    }
});

Ext.reg('extensible102.dayview', Calendar102.akgun.cal.DayView);
/**
 * @class Calendar102.akgun.cal.MultiDayView
 * @extends Calendar102.akgun.cal.DayView
 ...
 * use a {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel} to manage multiple calendar views at once.</p>
 * @constructor
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.MultiDayView = Ext.extend(Calendar102.akgun.cal.DayView, {
    /**
     * @cfg {Number} dayCount
     ...
     * <p>Some example {@link Calendar102.akgun.cal.CalendarPanel CalendarPanel} configs:</p>
     * <pre><code>
    // Weekdays only:
...
Ext.reg('extensible102.multidayview', Calendar102.akgun.cal.MultiDayView);/**
 * @class Calendar102.akgun.cal.WeekView
 * @extends Calendar102.akgun.cal.MultiDayView
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.WeekView = Ext.extend(Calendar102.akgun.cal.MultiDayView, {
    /**
     * @cfg {Number} dayCount
...
Ext.reg('extensible102.weekview', Calendar102.akgun.cal.WeekView);/**
 * @class Calendar102.akgun.cal.MultiWeekView
 * @extends Calendar102.akgun.cal.MonthView
 ...
 * @param {Object} config The config object
 */
Calendar102.akgun.cal.MultiWeekView = Ext.extend(Calendar102.akgun.cal.MonthView, {
    /**
...
Ext.reg('extensible102.multiweekview', Calendar102.akgun.cal.MultiWeekView);/*
 ...
 */
Calendar102.akgun.cal.MonthDayDetailView = Ext.extend(Ext.BoxComponent, {
    initComponent : function(){
        Calendar102.akgun.cal.CalendarView.superclass.initComponent.call(this);
    ...
    afterRender : function(){
        ...
        Calendar102.akgun.cal.MonthDayDetailView.superclass.afterRender.call(this);
    ...
    refresh : function(){
        ...
        var eventTpl = this.view.getEventTemplate(),
			...
			evts = this.store.queryBy(function(rec){
				...
				if(!startsOnDate){
					var recEnd = rec.data[Calendar102.akgun.cal.EventMappings.EndDate.name].clearTime(true).getTime();
	            	spansDate = recStart < thisDt && recEnd >= thisDt;
				}
	            return startsOnDate || spansDate;
	        }, this);
		
        Calendar102.akgun.cal.CalendarView.prototype.sortEventRecordsForDay.call(this, evts);
        
		evts.each(function(evt){
            var item = evt.data,
                M = Calendar102.akgun.cal.EventMappings;
                
			item._renderAsAllDay = item[M.IsAllDay.name] || Calendar102.akgun.Date.diffDays(item[M.StartDate.name], item[M.EndDate.name]) > 0;
            item.spanLeft = Calendar102.akgun.Date.diffDays(item[M.StartDate.name], this.date) > 0;
            item.spanRight = Calendar102.akgun.Date.diffDays(this.date, item[M.EndDate.name]) > 0;
...
Ext.reg('extensible102.monthdaydetailview', Calendar102.akgun.cal.MonthDayDetailView);
/**
 * @class Calendar102.akgun.cal.CalendarPanel
 * @extends Ext.Panel
 ...
 * {@link #Ext.data.Store store} config containing records of type {@link Calendar102.akgun.cal.EventRecord EventRecord}.</p>
 * @constructor
 * @param {Object} config The config object
 * @xtype calendarpanel
 */
Calendar102.akgun.cal.CalendarPanel = Ext.extend(Ext.Panel, {
    /**
     ...
     * active {@link Calendar102.akgun.cal.CalendarView view} at any time using the {@link #activeView} property.
     */
    /*
     * @cfg {Boolean} enableRecurrence
     * True to show the recurrence field, false to hide it (default). Note that recurrence requires
     ...
     * A config object that will be applied to all {@link Calendar102.akgun.cal.CalendarView views} managed by this CalendarPanel. Any
     * options on this object that do not apply to any particular view will simply be ignored.
     */
    /**
     * @cfg {Object} dayViewCfg
     * A config object that will be applied only to the {@link Calendar102.akgun.cal.DayView DayView} managed by this CalendarPanel.
     */
    /**
     * @cfg {Object} multiDayViewCfg
     * A config object that will be applied only to the {@link Calendar102.akgun.cal.MultiDayView MultiDayView} managed by this CalendarPanel.
     */
    /**
     * @cfg {Object} weekViewCfg
     * A config object that will be applied only to the {@link Calendar102.akgun.cal.WeekView WeekView} managed by this CalendarPanel.
     */
    /**
     * @cfg {Object} multiWeekViewCfg
     * A config object that will be applied only to the {@link Calendar102.akgun.cal.MultiWeekView MultiWeekView} managed by this CalendarPanel.
     */
    /**
     * @cfg {Object} monthViewCfg
     * A config object that will be applied only to the {@link Calendar102.akgun.cal.MonthView MonthView} managed by this CalendarPanel.
     */
    /**
     * @cfg {Object} editViewCfg
     * A config object that will be applied only to the {@link Calendar102.akgun.cal.EventEditForm EventEditForm} managed by this CalendarPanel.
     */
    
    /**
     * A reference to the {@link Calendar102.akgun.cal.CalendarView view} that is currently active.
     * @type {Calendar102.akgun.cal.CalendarView}
     * @property activeView
     */
    ...
    initComponent : function(){
        ...
        Calendar102.akgun.cal.CalendarPanel.superclass.initComponent.call(this);
        
        this.addEvents({
            /**
             * @event eventadd
             * Fires after a new event is added to the underlying store
             * @param {Calendar102.akgun.cal.CalendarPanel} this
             * @param {Calendar102.akgun.cal.EventRecord} rec The new {@link Calendar102.akgun.cal.EventRecord record} that was added
             */
            eventadd: true,
            /**
             ...
             * @param {Calendar102.akgun.cal.CalendarPanel} this
             * @param {Calendar102.akgun.CalendarView} view The view being activated (any valid {@link Calendar102.akgun.cal.CalendarView CalendarView} subclass)
             ...
             * (by default, an instance of {@link Calendar102.akgun.cal.EventEditForm}). Handling code should hide the active
             * event editor and transfer the current event record to the appropriate instance of the detailed form by showing it
             * and calling {@link Calendar102.akgun.cal.EventEditForm#loadRecord loadRecord}.
             * @param {Calendar102.akgun.cal.CalendarPanel} this The CalendarPanel
             * @param {Calendar102.akgun.cal.CalendarView} view The currently active {@link Calendar102.akgun.cal.CalendarView CalendarView} subclass
             * @param {Calendar102.akgun.cal.EventRecord} rec The {@link Calendar102.akgun.cal.EventRecord record} that is currently being edited
             * @param {Ext.Element} el The target element
             */
            editdetails: true
             ...
             * {@link Calendar102.akgun.cal.CalendarView CalendarView} subclasses in that it provides a default implementation (showing
        ...
        if(this.showMultiDayView){
            var mday = Ext.apply({
                xtype: 'extensible102.multidayview',
        ...
        if(this.showMultiWeekView){
            var mwk = Ext.applyIf({
                xtype: 'extensible102.multiweekview',
        ...
        this.add(Ext.applyIf({
            xtype: 'extensible102.eventeditform',
            id: this.id+'-edit',
            calendarStore: this.calendarStore,
            enableRecurrence: this.enableRecurrence,
            listeners: {
    ...
    // private
    afterRender: function(){
        Calendar102.akgun.cal.CalendarPanel.superclass.afterRender.call(this);
    ...
    // private
    onLayout: function(){
        Calendar102.akgun.cal.CalendarPanel.superclass.onLayout.call(this);
     ...
     * @param {Calendar102.akgun.cal.EventRecord} record The event record to edit
     * @return {Calendar102.akgun.cal.CalendarPanel} this
     */
     ...
     */
    setStartDate: function(dt){
        Calendar102.akgun.log('setStartDate (CalendarPanel');
        this.startDate = dt;
     ...
     * {@link Calendar102.akgun.cal.CalendarView CalendarView}.
     * @return {Calendar102.akgun.cal.CalendarView} The active view
     */
...
Ext.reg('extensible102.calendarpanel', Calendar102.akgun.cal.CalendarPanel);