...
//            this.removeAllListeners();
    ...
    ,setDate:function(date) {
     ...
     ,setAllowBlank:function(allowBlank){  // life is easier now, dear mike :)
      this.df.allowBlank=allowBlank;
      this.tf.allowBlank=allowBlank;
    },
    setMaxValue:function(date) {
        this.df.setMaxValue(date);
       // this.tf.setMaxValue(date); maybe in the next version this will work :)
    } // eo function setDate
     ,setMinValue:function(date) {
        this.df.minValue=date;
       // this.tf.setMinValue(date); maybe in the next version this will work :)
    } // eo function setDate
    // }}}
    // {{{
    /** 
