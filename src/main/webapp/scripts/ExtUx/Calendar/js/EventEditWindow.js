...
Ext.calendar.EventEditWindow = function(config) {
    ...
    Ext.calendar.EventEditWindow.superclass.constructor.call(this, Ext.apply({
        titleTextAdd: E0025UY015,//'Add Event',
        titleTextEdit: E0025CAS5920,//'Edit Event',
        width: 600,
        autocreate: true,
        border: true,
        closeAction: 'hide',
        ...
        resizable: false,
        buttonAlign: 'left',
        savingMessage: E0025UY012, //'Saving changes...',
        deletingMessage: E0025CAS5918, //'Deleting event...',

        fbar: [{
            xtype: 'tbtext',
            text: '<a href="#" id="tblink">' + E0025UY014 + '</a>'
        },
        '->', {
            text: UY003,//'Save',
            disabled: false,
