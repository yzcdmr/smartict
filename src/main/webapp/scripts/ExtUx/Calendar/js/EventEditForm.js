...
Ext.calendar.EventEditForm = Ext.extend(Ext.form.FormPanel, {
    labelWidth: 65,
    title: E0025UY021, //'Event Form',
    titleTextAdd: E0025UY015, //'Add Event',
    titleTextEdit: E0025UY015, //'Edit Event',
    bodyStyle: 'background:transparent;padding:20px 20px 10px;',
    border: false,
    buttonAlign: 'center',
    autoHeight: true,
    ...
    initComponent: function() {
        ...
        this.locationField = new Ext.form.TextField({
            fieldLabel: E0025UY020, //'Location',
