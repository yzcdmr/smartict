...
Ext.ux.Exporter.Button = Ext.extend(Ext.Button, {
  constructor: function(config) {
    ...
    Ext.applyIf(config, {
      ...
      text          : '___',
      cls           : 'viewIcon',
      tooltip		: 'Gridin Excel çıktısını almak için <b>tıklayınız</b>'
    });
...
Ext.ux.Exporter.ExcelFormatter.Worksheet = Ext.extend(Object, {
  ...
  buildColumn: function(width) {
    return String.format('<ss:Column ss:AutoFitWidth="1" ss:Width="{0}" />', width || 80);
  },
